...
│   └── models.py        # Структура данных для БД
├── static/
...
- [x] База данных
- [x] Алгоритм хеширования
Потому что зачем полагаться на сторонние сервисы, если вы можете быть своим собственным героем сокращения URL? 🦸‍♂️
- [ ] Страница статистики
